...
const Lab5 = (app) => {
  ...
  app.get("/a5/todos/:id/completed/:completed", (req, res) => {
    ...
    const complete = todos.find((t) => t.completed === completed);
    res.json(complete);
  });
  app.get("/a5/todos/:id/description/:description", (req, res) => {
    const { description } = req.params;
    const descript = todos.find((t) => t.description === description);
    res.json(descript);
  });
  ...
  app.get("/a5/assignment/description/:newDescription", (req, res) => {
    console.log(req.params);
  ...
  app.get("/a5/assignment/title/:newCompleted", (req, res) => {});
  ...
  app.get("/a5/assignment/completed", (req, res) => {
    const completion = assignment.completed;
    res.json(completion.toString());
  });
  app.get("/a5/assignment/score", (req, res) => {
    const assignScore = parseInt(assignment.score);
    res.json(assignScore.toString());
  });
